...
import { FileText, Upload, BarChart3, List, Settings, Folder } from 'lucide-react';
      ...
      <header className="border-b bg-white/90 backdrop-blur-sm sticky top-0 z-40 shadow-sm">
        <div className="container mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex gap-6">
            <Link to="/projects" className="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition-colors font-medium">
              <Folder className="h-4 w-4" />
              Projects
            </Link>
            <Link to="/global-stats" className="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition-colors font-medium">
